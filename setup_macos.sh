...
echo "Installing kubectl and helper tools"
brew install jq gettext bash-completion moreutils kubectl
...
eksctl completion bash > $(brew --prefix)/etc/bash_completion.d/kubectl
